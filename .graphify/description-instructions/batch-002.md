...
- "components_locationlanding": "LocationLanding.tsx" | kind=code-symbol | source=src/components/LocationLanding.tsx:L1 | neighbors=[b48bbc0 chore: snapshot lokale SEO-pagi…, e0f6b72 feat(seo): interne links op lok…, CookieBanner.tsx, CookieBanner(), Footer.tsx, Footer()] | lang=en
- "routes_werkwijze": "werkwijze.tsx" | kind=code-symbol | source=src/routes/werkwijze.tsx:L1 | neighbors=[2d81f50 feat(seo): vervang /cases door …, CookieBanner.tsx, CookieBanner(), Footer.tsx, Footer(), Nav.tsx] | lang=en
...
- "components_servicepage": "ServicePage.tsx" | kind=code-symbol | source=src/components/ServicePage.tsx:L1 | neighbors=[f207e52 feat(seo): dienstenpagina's web…, CookieBanner.tsx, CookieBanner(), Footer.tsx, Footer(), Nav.tsx] | lang=en
...
- "routes_contact": "contact.tsx" | kind=code-symbol | source=src/routes/contact.tsx:L1 | neighbors=[9965896 feat(seo): contact- en cases-pa…, Contact.tsx, Contact(), CookieBanner.tsx, CookieBanner(), Footer.tsx] | lang=en
