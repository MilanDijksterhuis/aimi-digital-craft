# Node Description Batch 3 of 34
...
- "lib_rbac": "rbac.ts" | kind=code-symbol | source=src/lib/rbac.ts:L1 | neighbors=[81a87ed commit, c480d2e leads, TeamTab.tsx, use-permissions.tsx, ALL_PERMISSION_ACTIONS, AppRole] | lang=en
