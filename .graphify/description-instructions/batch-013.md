# Node Description Batch 14 of 47
...
- "src_server_applysecurityheaders": "applySecurityHeaders()" | kind=code-symbol | source=src/server.ts:L166 | neighbors=[server.ts, applyAssetCaching(), isHttps(), fetch()]
