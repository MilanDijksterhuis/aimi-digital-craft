...
- "components_nav_nav": "Nav()" | kind=code-symbol | source=src/components/Nav.tsx:L141 | neighbors=[LocationLanding.tsx, Nav.tsx, ServicePage.tsx, contact.tsx, faq.tsx, index.tsx] | lang=en
...
- "routes_website_laten_maken_hoogeveen": "website-laten-maken-hoogeveen.tsx" | kind=code-symbol | source=src/routes/website-laten-maken-hoogeveen.tsx:L1 | neighbors=[2d81f50 feat(seo): vervang /cases door …, b48bbc0 chore: snapshot lokale SEO-pagi…, e0f6b72 feat(seo): interne links op lok…, LocationLanding.tsx, LocationData, LocationLanding()] | lang=en
- "routes_website_laten_maken_veendam": "website-laten-maken-veendam.tsx" | kind=code-symbol | source=src/routes/website-laten-maken-veendam.tsx:L1 | neighbors=[2d81f50 feat(seo): vervang /cases door …, b48bbc0 chore: snapshot lokale SEO-pagi…, e0f6b72 feat(seo): interne links op lok…, LocationLanding.tsx, LocationData, LocationLanding()] | lang=en
