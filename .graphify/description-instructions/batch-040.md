# Node Description Batch 41 of 52
...
- "routes_blog_blog": "Blog()" | kind=code-symbol | source=src/routes/blog.tsx:L69 | neighbors=[blog.tsx]
- "routes_blog_bloglistitem": "BlogListItem" | kind=code-symbol | source=src/routes/blog.tsx:L10 | neighbors=[blog.tsx]
- "routes_blog_slug_blogpost": "BlogPost()" | kind=code-symbol | source=src/routes/blog_.$slug.tsx:L72 | neighbors=[blog_.$slug.tsx]
- "routes_blog_slug_blogpostdetail": "BlogPostDetail" | kind=code-symbol | source=src/routes/blog_.$slug.tsx:L10 | neighbors=[blog_.$slug.tsx]
- "routes_blog_slug_route": "Route" | kind=code-symbol | source=src/routes/blog_.$slug.tsx:L21 | neighbors=[blog_.$slug.tsx]
