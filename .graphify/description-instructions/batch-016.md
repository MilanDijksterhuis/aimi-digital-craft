# Node Description Batch 17 of 32
...
- "authenticated_portal_stat": "Stat()" | kind=code-symbol | source=src/routes/_authenticated/portal.tsx:L692 | neighbors=[portal.tsx]
- "authenticated_portal_status_style": "STATUS_STYLE" | kind=code-symbol | source=src/routes/_authenticated/portal.tsx:L73 | neighbors=[portal.tsx]
- "authenticated_portal_statusbadge": "StatusBadge()" | kind=code-symbol | source=src/routes/_authenticated/portal.tsx:L720 | neighbors=[portal.tsx]
- "authenticated_portal_statuskey": "StatusKey" | kind=code-symbol | source=src/routes/_authenticated/portal.tsx:L62 | neighbors=[portal.tsx]
- "authenticated_portal_steps": "STEPS" | kind=code-symbol | source=src/routes/_authenticated/portal.tsx:L82 | neighbors=[portal.tsx]
- "authenticated_portal_uptimechart": "UptimeChart()" | kind=code-symbol | source=src/routes/_authenticated/portal.tsx:L1088 | neighbors=[portal.tsx]
- "authenticated_portal_websitetab": "WebsiteTab()" | kind=code-symbol | source=src/routes/_authenticated/portal.tsx:L1115 | neighbors=[portal.tsx]
...
- "components_contact_field": "Field()" | kind=code-symbol | source=src/components/Contact.tsx:L221 | neighbors=[Contact.tsx]
