# Node Description Batch 46 of 57
...
- "routes_root_rootcomponent": "RootComponent()" | kind=code-symbol | source=src/routes/__root.tsx:L300 | neighbors=[__root.tsx]
- "routes_root_rootshell": "RootShell()" | kind=code-symbol | source=src/routes/__root.tsx:L283 | neighbors=[__root.tsx]
...
- "routes_sitemap_xml_route": "Route" | kind=code-symbol | source=src/routes/sitemap[.]xml.tsx:L8 | neighbors=[sitemap[.]xml.tsx]
...
- "routes_tarieven_comparison": "comparison" | kind=code-symbol | source=src/routes/tarieven.tsx:L114 | neighbors=[tarieven.tsx]
- "routes_tarieven_faqs": "faqs" | kind=code-symbol | source=src/routes/tarieven.tsx:L147 | neighbors=[tarieven.tsx]
- "routes_tarieven_included": "included" | kind=code-symbol | source=src/routes/tarieven.tsx:L98 | neighbors=[tarieven.tsx]
- "routes_tarieven_notincluded": "notIncluded" | kind=code-symbol | source=src/routes/tarieven.tsx:L107 | neighbors=[tarieven.tsx]
- "routes_tarieven_recurring": "recurring" | kind=code-symbol | source=src/routes/tarieven.tsx:L81 | neighbors=[tarieven.tsx]
- "routes_tarieven_tarievenpage": "TarievenPage()" | kind=code-symbol | source=src/routes/tarieven.tsx:L265 | neighbors=[tarieven.tsx]
- "routes_tarieven_tier": "Tier" | kind=code-symbol | source=src/routes/tarieven.tsx:L24 | neighbors=[tarieven.tsx]
- "routes_tarieven_tiers": "tiers" | kind=code-symbol | source=src/routes/tarieven.tsx:L34 | neighbors=[tarieven.tsx]
