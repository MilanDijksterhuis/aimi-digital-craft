...
- "routes_algemene_voorwaarden_voorwaardenpage": "VoorwaardenPage()" | kind=code-symbol | source=src/routes/algemene-voorwaarden.tsx:L16 | neighbors=[algemene-voorwaarden.tsx]
...
- "routes_index_index": "Index()" | kind=code-symbol | source=src/routes/index.tsx:L48 | neighbors=[index.tsx]
- "routes_login_loginpage": "LoginPage()" | kind=code-symbol | source=src/routes/login.tsx:L19 | neighbors=[login.tsx]
