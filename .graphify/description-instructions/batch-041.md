# Node Description Batch 42 of 57
...
- "lib_seo_city_geo": "CITY_GEO" | kind=code-symbol | source=src/lib/seo.ts:L277 | neighbors=[seo.ts]
- "lib_seo_default_area_served": "DEFAULT_AREA_SERVED" | kind=code-symbol | source=src/lib/seo.ts:L265 | neighbors=[seo.ts]
- "lib_seo_ldscript": "LdScript" | kind=code-symbol | source=src/lib/seo.ts:L257 | neighbors=[seo.ts]
