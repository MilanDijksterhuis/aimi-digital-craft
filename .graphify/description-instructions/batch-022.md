# Node Description Batch 23 of 57
...
- "lib_seo_formatdatenl": "formatDateNL()" | kind=code-symbol | source=src/lib/seo.ts:L218 | neighbors=[UpdatedOn.tsx, seo.ts]
...
- "lib_site_pages_core_pages": "CORE_PAGES" | kind=code-symbol | source=src/lib/site-pages.ts:L5 | neighbors=[InternalLinkPicker.tsx, site-pages.ts]
- "lib_status_blog_status_label": "BLOG_STATUS_LABEL" | kind=code-symbol | source=src/lib/status.ts:L73 | neighbors=[admin.blog.tsx, status.ts]
- "lib_status_change_templates": "CHANGE_TEMPLATES" | kind=code-symbol | source=src/lib/status.ts:L102 | neighbors=[portal.tsx, status.ts]
