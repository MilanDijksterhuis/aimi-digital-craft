# Node Description Batch 7 of 35
...
- "lib_contact_functions": "contact.functions.ts" | kind=code-symbol | source=src/lib/contact.functions.ts:L1 | neighbors=[a3773ee sec fixes, adminDeleteContactSubmission, adminListContactSubmissions, adminToggleContactHandled, submitContactForm, auth-middleware.ts] | lang=en
