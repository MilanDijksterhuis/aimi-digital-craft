...
- "lib_seo_ld": "ld()" | kind=code-symbol | source=src/lib/seo.ts:L246 | neighbors=[seo.ts, breadcrumbJsonLd(), contactPageJsonLd(), faqJsonLd(), offeringsJsonLd(), serviceJsonLd()] | lang=en
