# Node Description Batch 11 of 46
...
- "commit:repo:github.com/MilanDijksterhuis/aimi-digital-craft@04564c5bc0439aedd94852a88644fb7ece2445c8": "04564c5 fixes" | kind=Commit | source=git | neighbors=[main, FAQ.tsx, Footer.tsx, index.tsx, __root.tsx, c27f4c8 new] | lang=en
...
- "lib_seo_faqjsonld": "faqJsonLd()" | kind=code-symbol | source=src/lib/seo.ts:L123 | neighbors=[seo.ts, ld(), faq.tsx, onderhoud-hosting.tsx, webshop-laten-maken.tsx, website-laten-maken.tsx] | lang=en
- "lib_seo_howtojsonld": "howToJsonLd()" | kind=code-symbol | source=src/lib/seo.ts:L89 | neighbors=[seo.ts, ld(), onderhoud-hosting.tsx, webshop-laten-maken.tsx, website-laten-maken.tsx, werkwijze.tsx] | lang=en
