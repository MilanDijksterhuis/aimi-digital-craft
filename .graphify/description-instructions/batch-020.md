# Node Description Batch 21 of 46
...
- "src_server_redirecttrailingslash": "redirectTrailingSlash()" | kind=code-symbol | source=src/server.ts:L273 | neighbors=[server.ts, fetch()]
