# Node Description Batch 29 of 52
...
- "components_contact_field": "Field()" | kind=code-symbol | source=src/components/Contact.tsx:L297 | neighbors=[Contact.tsx]
...
- "components_faq_categoryslug": "categorySlug()" | kind=code-symbol | source=src/components/FAQ.tsx:L168 | neighbors=[FAQ.tsx]
- "components_faq_faq_categories": "FAQ_CATEGORIES" | kind=code-symbol | source=src/components/FAQ.tsx:L10 | neighbors=[FAQ.tsx]
- "components_faq_faqaccordionrow": "FaqAccordionRow()" | kind=code-symbol | source=src/components/FAQ.tsx:L176 | neighbors=[FAQ.tsx]
