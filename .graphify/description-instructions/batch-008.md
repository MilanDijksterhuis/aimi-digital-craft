# Node Description Batch 9 of 57
...
- "commit:repo:github.com/MilanDijksterhuis/aimi-digital-craft@f5b75ff1a1588c6e0e5dcbf7956086ed1be0c8c6": "f5b75ff Code edited in Lovable Code Editor" | kind=Commit | source=git | neighbors=[3e100e8 Fixed security findings, main, 273dbce Code edited in Lovable Code Edi…, routeTree.gen.ts, tmp-main-merge, tmp-revert-main] | lang=en
...
- "components_answerblock": "AnswerBlock.tsx" | kind=code-symbol | source=src/components/AnswerBlock.tsx:L1 | neighbors=[6e488ba fixes, dca01f9 pagina updates, e84aa2e hoofdpagina, AnswerBlock(), HOOGEVEEN, VEENDAM] | lang=en
...
- "src_server_fetch": "fetch()" | kind=code-symbol | source=src/server.ts:L452 | neighbors=[server.ts, applyRateLimit(), applySecurityHeaders(), brandedErrorResponse(), compressStaticAsset(), fixNotFoundTitle()] | lang=en
- "supabase_auth_middleware": "auth-middleware.ts" | kind=code-symbol | source=src/integrations/supabase/auth-middleware.ts:L1 | neighbors=[accounts.functions.ts, admin.functions.ts, blog.functions.ts, contact.functions.ts, monitoring.functions.ts, portal.functions.ts] | lang=en
...
- "authenticated_admin_blog_postid": "admin.blog.$postId.tsx" | kind=code-symbol | source=src/routes/_authenticated/admin.blog.$postId.tsx:L1 | neighbors=[AdminBlogPostDetailPage(), Route, BlogPostForm.tsx, BlogPostFaqItem, BlogPostForm(), BlogPostFormPayload] | lang=en
