...
- "commit:repo:github.com/MilanDijksterhuis/aimi-digital-craft@f2eb4fee5708d1ae2198a43a0ef81a988ec315f0": "f2eb4fe Fix root cause: catch Supabase Realtime WebSocket crashes" | kind=Commit | source=git | neighbors=[02d6137 fixes, admin.tsx, admin.accounts.tsx, main, seo-verbetering, c27ffd9 fixes] | lang=en
...
- "components_footer_footer": "Footer()" | kind=code-symbol | source=src/components/Footer.tsx:L40 | neighbors=[Footer.tsx, LocationLanding.tsx, algemene-voorwaarden.tsx, faq.tsx, index.tsx, over-ons.tsx] | lang=en
...
- "routes_website_laten_maken_hoogeveen": "website-laten-maken-hoogeveen.tsx" | kind=code-symbol | source=src/routes/website-laten-maken-hoogeveen.tsx:L1 | neighbors=[b48bbc0 chore: snapshot lokale SEO-pagi…, LocationLanding.tsx, LocationData, LocationLanding(), data, Route] | lang=en
- "routes_website_laten_maken_veendam": "website-laten-maken-veendam.tsx" | kind=code-symbol | source=src/routes/website-laten-maken-veendam.tsx:L1 | neighbors=[b48bbc0 chore: snapshot lokale SEO-pagi…, LocationLanding.tsx, LocationData, LocationLanding(), data, Route] | lang=en
...
- "commit:repo:github.com/MilanDijksterhuis/aimi-digital-craft@a2681a9e5aba53942b6b04ef7a01b7dd2aadfac9": "a2681a9 ewa" | kind=Commit | source=git | neighbors=[81a87ed commit, main, seo-verbetering, worktree-replicated-fluttering-whisper, 2fcc9a3 fixes, admin.functions.ts] | lang=pt
- "commit:repo:github.com/MilanDijksterhuis/aimi-digital-craft@bbc9d80c493eedf605f2e81d53384f621534a44f": "bbc9d80 Surface site_errors in the account Activiteit tab" | kind=Commit | source=git | neighbors=[2189780 fixes, admin.accounts.$accountId.tsx, main, seo-verbetering, 02d6137 fixes, accounts.server.ts] | lang=en
- "components_cookiebanner_cookiebanner": "CookieBanner()" | kind=code-symbol | source=src/components/CookieBanner.tsx:L25 | neighbors=[CookieBanner.tsx, LocationLanding.tsx, faq.tsx, index.tsx, meer-diensten.tsx, over-ons.tsx] | lang=en
- "components_nav_nav": "Nav()" | kind=code-symbol | source=src/components/Nav.tsx:L12 | neighbors=[LocationLanding.tsx, Nav.tsx, faq.tsx, index.tsx, meer-diensten.tsx, over-ons.tsx] | lang=en
