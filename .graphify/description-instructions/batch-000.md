...
- "lib_accounts_functions": "accounts.functions.ts" | kind=code-symbol | source=src/lib/accounts.functions.ts:L1 | neighbors=[81a87ed commit, 9e611dd Changes, a3773ee sec fixes, c480d2e leads, cf4ac91 Alle fases toegevoegd & cron re…, ADMIN_LIKE]
...
- "lib_monitoring_functions": "monitoring.functions.ts" | kind=code-symbol | source=src/lib/monitoring.functions.ts:L1 | neighbors=[0193196 monitoring, 39d363a server basic, a3773ee sec fixes, ADMIN_LIKE, ensureAdmin(), getAlerts]
...
- "commit:repo:github.com/MilanDijksterhuis/aimi-digital-craft@a3773ee34a596fb2964b7b639fc365984e0098aa": "a3773ee sec fixes" | kind=Commit | source=git | neighbors=[main, Contact.tsx, accounts.functions.ts, admin.functions.ts, contact.functions.ts, email.server.ts]
