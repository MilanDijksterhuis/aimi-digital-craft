...
- "routes_index": "index.tsx" | kind=code-symbol | source=src/routes/index.tsx:L1 | neighbors=[04c01f8 SEO, 129b916 manier van werken, 5820182 Changes, 5d3df91 new, 6262799 fixes, 85a6666 SEO en robot]
...
- "routes_root": "__root.tsx" | kind=code-symbol | source=src/routes/__root.tsx:L1 | neighbors=[37c0d11 Dock tokens toegevoegd & emojis…, 408d241 Changes, 422202c Made the requested updates, 5d3df91 new, 779aebc Nieuwe Lottielab-look toegepast, 85a6666 SEO en robot]
- "components_nav": "Nav.tsx" | kind=code-symbol | source=src/components/Nav.tsx:L1 | neighbors=[05a6c9e Verbeter admin changes-tab layo…, 0cfedfb Changes, 2d81f50 feat(seo): vervang /cases door …, 6262799 fixes, 7476011 Changes, 79f7d0a Changes]
