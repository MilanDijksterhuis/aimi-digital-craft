# Node Description Batch 1 of 32
...
- "branch:repo:github.com/MilanDijksterhuis/aimi-digital-craft#main": "main" | kind=Branch | source=git | neighbors=[00d6931 Changes, 00e2564 voorwaaren en privacy, 0193196 monitoring, 020d807 Changes, 0332090 Changes, 05a6c9e Verbeter admin changes-tab layo…]
...
- "lib_admin_functions": "admin.functions.ts" | kind=code-symbol | source=src/lib/admin.functions.ts:L1 | neighbors=[12764e3 Security: fix IDOR vulnerabilit…, 2d50590 wip: lokale wijzigingen voor pu…, 39d363a server basic, 3ca59a0 Changes, 5bc9ff0 google authenticatoin, 7f7208a new]
...
- "lib_portal_functions": "portal.functions.ts" | kind=code-symbol | source=src/lib/portal.functions.ts:L1 | neighbors=[12764e3 Security: fix IDOR vulnerabilit…, 15acc2a Changes, 7f7208a new, 81a87ed commit, 8c0bb37 nieuwe featues, 9be6953 bug fixes]
...
- "routes_root": "__root.tsx" | kind=code-symbol | source=src/routes/__root.tsx:L1 | neighbors=[37c0d11 Dock tokens toegevoegd & emojis…, 408d241 Changes, 422202c Made the requested updates, 538314c Contactformulier en adminfix, 5597edf Changes, 779aebc Nieuwe Lottielab-look toegepast]
...
- "src_server": "server.ts" | kind=code-symbol | source=src/server.ts:L1 | neighbors=[23bb181 sec, 2d50590 wip: lokale wijzigingen voor pu…, e2cd310 Ip blocker, f67dba7 rate limiting, error-capture.ts, consumeLastCapturedError()]
...
- "routes_authenticated": "_authenticated.tsx" | kind=code-symbol | source=src/routes/_authenticated.tsx:L1 | neighbors=[41d8eb5 Changes, 423b3f1 cashing, 68ae2dd Changes, 6dc7740 Changes, 85ad012 Cinematisch redesign: forest he…, 965b87a Fix foto, nav animaties, portal…]
...
- "commit:repo:github.com/MilanDijksterhuis/aimi-digital-craft@ab14295bf0f991ae5f05ccf837cbcab6dfd984fa": "ab14295 Design overhauled, A11y-bar weg" | kind=Commit | source=git | neighbors=[538314c Contactformulier en adminfix, 90677bf Changes, main, tmp-main-merge, tmp-revert-main, worktree-curious-wibbling-narwhal]
...
- "lib_admin_server": "admin.server.ts" | kind=code-symbol | source=src/lib/admin.server.ts:L1 | neighbors=[5bc9ff0 google authenticatoin, b29ceec Fixed weak PRNG and RLS, b83b044 Revert: verwijder Google OAuth …, c480d2e leads, adminCreateCustomer(), adminGenerateRecoveryLink()]
