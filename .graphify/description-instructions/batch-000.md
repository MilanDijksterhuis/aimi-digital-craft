# Node Description Batch 1 of 46
...
- "src_routetree_gen": "routeTree.gen.ts" | kind=code-symbol | source=src/routeTree.gen.ts:L1 | neighbors=[00e2564 voorwaaren en privacy, 0193196 monitoring, 020d807 Changes, 273dbce Code edited in Lovable Code Edi…, 2b1d78f telegram, 2d50590 wip: lokale wijzigingen voor pu…]
...
- "lib_seo": "seo.ts" | kind=code-symbol | source=src/lib/seo.ts:L1 | neighbors=[5d3df91 new, 8fdd571 SEO, c27f4c8 new, f207e52 feat(seo): dienstenpagina's web…, breadcrumbJsonLd(), cityAreaServed()]
...
- "routes_index": "index.tsx" | kind=code-symbol | source=src/routes/index.tsx:L1 | neighbors=[04564c5 fixes, 04c01f8 SEO, 129b916 manier van werken, 5820182 Changes, 5d3df91 new, 6262799 fixes]
...
- "components_nav": "Nav.tsx" | kind=code-symbol | source=src/components/Nav.tsx:L1 | neighbors=[05a6c9e Verbeter admin changes-tab layo…, 2d81f50 feat(seo): vervang /cases door …, 6262799 fixes, 7476011 Changes, 79f7d0a Changes, 7d64543 Changes]
...
- "routes_root": "__root.tsx" | kind=code-symbol | source=src/routes/__root.tsx:L1 | neighbors=[04564c5 fixes, 37c0d11 Dock tokens toegevoegd & emojis…, 408d241 Changes, 422202c Made the requested updates, 5d3df91 new, 779aebc Nieuwe Lottielab-look toegepast]
- "routes_meer_diensten": "meer-diensten.tsx" | kind=code-symbol | source=src/routes/meer-diensten.tsx:L1 | neighbors=[04c01f8 SEO, 1c0e00f fixes, 5d3df91 new, 6262799 fixes, 8fdd571 SEO, b48bbc0 chore: snapshot lokale SEO-pagi…]
...
- "src_server": "server.ts" | kind=code-symbol | source=src/server.ts:L1 | neighbors=[23bb181 sec, 2d50590 wip: lokale wijzigingen voor pu…, 3901302 Fix mojibake in admin dashboard…, 5d1e827 Log server-side (SSR) crashes t…, 5d3df91 new, 85a6666 SEO en robot]
- "components_locationpagev2": "LocationPageV2.tsx" | kind=code-symbol | source=src/components/LocationPageV2.tsx:L1 | neighbors=[c27f4c8 new, CookieBanner.tsx, CookieBanner(), Footer.tsx, Footer(), BusinessTypesSection()]
...
- "components_footer": "Footer.tsx" | kind=code-symbol | source=src/components/Footer.tsx:L1 | neighbors=[00e2564 voorwaaren en privacy, 04564c5 fixes, 2d7a8d4 teksr wijzigingen, 2d81f50 feat(seo): vervang /cases door …, 85ad012 Cinematisch redesign: forest he…, 9a2689c code fixes]
