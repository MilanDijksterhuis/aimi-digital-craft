# Node Description Batch 1 of 35
...
- "lib_portal_functions": "portal.functions.ts" | kind=code-symbol | source=src/lib/portal.functions.ts:L1 | neighbors=[12764e3 Security: fix IDOR vulnerabilit…, 15acc2a Changes, 2fcc9a3 fixes, 3417a43 fixes, 7f7208a new, 81a87ed commit]
...
- "lib_accounts_functions": "accounts.functions.ts" | kind=code-symbol | source=src/lib/accounts.functions.ts:L1 | neighbors=[81a87ed commit, 9e611dd Changes, a3773ee sec fixes, c480d2e leads, cf4ac91 Alle fases toegevoegd & cron re…, adminArchiveChange]
...
- "lib_monitoring_functions": "monitoring.functions.ts" | kind=code-symbol | source=src/lib/monitoring.functions.ts:L1 | neighbors=[0193196 monitoring, 39d363a server basic, a3773ee sec fixes, getAlerts, getDailyCheckLatest, getHetznerCostsHistory]
