# Node Description Batch 1 of 57
...
- "lib_seo": "seo.ts" | kind=code-symbol | source=src/lib/seo.ts:L1 | neighbors=[13e217a SEO, 1727351 blog, 36d8ccb new pages, 59bb970 eyoo, 5d3df91 new, 8fdd571 SEO]
...
- "design_handoff_meer_diensten_support": "support.js" | kind=code-symbol | source=design/geanimeerde-achtergronden/design_handoff_meer_diensten/support.js:L1 | neighbors=[65ab188 fixes, boot(), bundledBlob(), cdnScriptFor(), collectProps(), compileAttr()]
- "kaart_hoogeveen_veendam_support": "support.js" | kind=code-symbol | source=design/kaart-hoogeveen-veendam/support.js:L1 | neighbors=[65ab188 fixes, boot(), bundledBlob(), cdnScriptFor(), collectProps(), compileAttr()]
...
- "commit:repo:github.com/MilanDijksterhuis/aimi-digital-craft@4a960c65923583d07f26052f49acd65056f0af9b": "4a960c6 SEO" | kind=Commit | source=git | neighbors=[main, 13e217a SEO, Footer.tsx, Hero.tsx, markdown.tsx, 20260917120000_blog_batch2_new_posts_sc…]
...
- "routes_index": "index.tsx" | kind=code-symbol | source=src/routes/index.tsx:L1 | neighbors=[04564c5 fixes, 04c01f8 SEO, 129b916 manier van werken, 13e217a SEO, 36d8ccb new pages, 5820182 Changes]
...
- "components_branchpage": "BranchPage.tsx" | kind=code-symbol | source=src/components/BranchPage.tsx:L1 | neighbors=[13e217a SEO, 36d8ccb new pages, 6e488ba fixes, aabf034 SEO, b5c2a22 blog, c27f4c8 new]
- "lib_seo_breadcrumbjsonld": "breadcrumbJsonLd()" | kind=code-symbol | source=src/lib/seo.ts:L341 | neighbors=[seo.ts, ld(), blog.tsx, blog_.$slug.tsx, branches.tsx, contact.tsx]
...
- "lib_seo_faqjsonld": "faqJsonLd()" | kind=code-symbol | source=src/lib/seo.ts:L424 | neighbors=[seo.ts, ld(), blog_.$slug.tsx, faq.tsx, seo.tsx, tarieven.tsx]
- "lib_seo_servicejsonld": "serviceJsonLd()" | kind=code-symbol | source=src/lib/seo.ts:L316 | neighbors=[seo.ts, ld(), meer-diensten.tsx, onderhoud-hosting.tsx, seo.tsx, webdesign.tsx]
...
- "components_servicepage": "ServicePage.tsx" | kind=code-symbol | source=src/components/ServicePage.tsx:L1 | neighbors=[13e217a SEO, 36d8ccb new pages, 5d3df91 new, 6262799 fixes, 8fdd571 SEO, aabf034 SEO]
