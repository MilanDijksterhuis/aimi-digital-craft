# Node Description Batch 28 of 57
...
- "authenticated_admin_adminpage": "AdminPage()" | kind=code-symbol | source=src/routes/_authenticated/admin.tsx:L92 | neighbors=[admin.tsx]
- "authenticated_admin_adminsidebar": "AdminSidebar()" | kind=code-symbol | source=src/routes/_authenticated/admin.tsx:L580 | neighbors=[admin.tsx]
- "authenticated_admin_afsprakentab": "AfsprakenTab()" | kind=code-symbol | source=src/routes/_authenticated/admin.tsx:L829 | neighbors=[admin.tsx]
- "authenticated_admin_alertspanel": "AlertsPanel()" | kind=code-symbol | source=src/routes/_authenticated/admin.tsx:L1161 | neighbors=[admin.tsx]
- "authenticated_admin_archivedchangespanel": "ArchivedChangesPanel()" | kind=code-symbol | source=src/routes/_authenticated/admin.tsx:L1098 | neighbors=[admin.tsx]
- "authenticated_admin_blog_adminblogpage": "AdminBlogPage()" | kind=code-symbol | source=src/routes/_authenticated/admin.blog.tsx:L63 | neighbors=[admin.blog.tsx]
- "authenticated_admin_blog_blogsidebar": "BlogSidebar()" | kind=code-symbol | source=src/routes/_authenticated/admin.blog.tsx:L108 | neighbors=[admin.blog.tsx]
- "authenticated_admin_blog_newpostsection": "NewPostSection()" | kind=code-symbol | source=src/routes/_authenticated/admin.blog.tsx:L453 | neighbors=[admin.blog.tsx]
- "authenticated_admin_blog_postid_adminblogpostdetailpage": "AdminBlogPostDetailPage()" | kind=code-symbol | source=src/routes/_authenticated/admin.blog.$postId.tsx:L21 | neighbors=[admin.blog.$postId.tsx]
- "authenticated_admin_blog_postid_route": "Route" | kind=code-symbol | source=src/routes/_authenticated/admin.blog.$postId.tsx:L14 | neighbors=[admin.blog.$postId.tsx]
- "authenticated_admin_blog_postslistsection": "PostsListSection()" | kind=code-symbol | source=src/routes/_authenticated/admin.blog.tsx:L174 | neighbors=[admin.blog.tsx]
- "authenticated_admin_blog_section": "Section" | kind=code-symbol | source=src/routes/_authenticated/admin.blog.tsx:L61 | neighbors=[admin.blog.tsx]
- "authenticated_admin_blog_tabkey": "TabKey" | kind=code-symbol | source=src/routes/_authenticated/admin.blog.tsx:L172 | neighbors=[admin.blog.tsx]
- "authenticated_admin_blog_tableskeleton": "TableSkeleton()" | kind=code-symbol | source=src/routes/_authenticated/admin.blog.tsx:L40 | neighbors=[admin.blog.tsx]
- "authenticated_admin_card": "Card()" | kind=code-symbol | source=src/routes/_authenticated/admin.tsx:L567 | neighbors=[admin.tsx]
...
- "authenticated_admin_dashboard": "Dashboard()" | kind=code-symbol | source=src/routes/_authenticated/admin.tsx:L379 | neighbors=[admin.tsx]
