# Node Description Batch 2 of 57
...
- "commit:repo:github.com/MilanDijksterhuis/aimi-digital-craft@13e217a92e895492d3aa339ad8aa57de900baa78": "13e217a SEO" | kind=Commit | source=git | neighbors=[main, 65ab188 fixes, BranchLinks.tsx, BranchPage.tsx, Contact.tsx, ExampleSlideshow.tsx]
...
- "routes_tarieven": "tarieven.tsx" | kind=code-symbol | source=src/routes/tarieven.tsx:L1 | neighbors=[13e217a SEO, 36d8ccb new pages, 59bb970 eyoo, 6e488ba fixes, aabf034 SEO, cc405f4 pagina updates]
...
- "components_contact": "Contact.tsx" | kind=code-symbol | source=src/components/Contact.tsx:L1 | neighbors=[0332090 Changes, 0b21971 Changes weergave verbeterd, 13e217a SEO, 6262799 fixes, 6e488ba fixes, 735e902 Verwijder alle section-label ey…]
...
- "routes_website_laten_maken": "website-laten-maken.tsx" | kind=code-symbol | source=src/routes/website-laten-maken.tsx:L1 | neighbors=[04c01f8 SEO, 13e217a SEO, 4a960c6 SEO, 5d3df91 new, 6e488ba fixes, 8fdd571 SEO]
...
- "routes_contact": "contact.tsx" | kind=code-symbol | source=src/routes/contact.tsx:L1 | neighbors=[04c01f8 SEO, 13e217a SEO, 36d8ccb new pages, 4a960c6 SEO, 59bb970 eyoo, 5d3df91 new]
