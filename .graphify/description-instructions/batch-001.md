...
- "routes_website_checker": "website-checker.tsx" | kind=code-symbol | source=src/routes/website-checker.tsx:L1 | neighbors=[6e488ba fixes, dda7a04 web tester, CookieBanner.tsx, CookieBanner(), Footer.tsx, Footer()]
...
- "routes_website_laten_maken_hoogeveen": "website-laten-maken-hoogeveen.tsx" | kind=code-symbol | source=src/routes/website-laten-maken-hoogeveen.tsx:L1 | neighbors=[04c01f8 SEO, 1c0e00f fixes, 2d81f50 feat(seo): vervang /cases door …, 36d8ccb new pages, 5d3df91 new, 6e488ba fixes]
...
- "routes_onderhoud_hosting": "onderhoud-hosting.tsx" | kind=code-symbol | source=src/routes/onderhoud-hosting.tsx:L1 | neighbors=[04c01f8 SEO, 2d81f50 feat(seo): vervang /cases door …, 36d8ccb new pages, 5d3df91 new, 6e488ba fixes, 8fdd571 SEO]
...
- "routes_faq": "faq.tsx" | kind=code-symbol | source=src/routes/faq.tsx:L1 | neighbors=[36d8ccb new pages, 5d3df91 new, 6e488ba fixes, 8fdd571 SEO, dca01f9 pagina updates, fc7da2d animaties en paginas]
...
- "routes_over_ons": "over-ons.tsx" | kind=code-symbol | source=src/routes/over-ons.tsx:L1 | neighbors=[04c01f8 SEO, 2d81f50 feat(seo): vervang /cases door …, 36d8ccb new pages, 5d3df91 new, 6262799 fixes, 6e488ba fixes]
- "routes_seo": "seo.tsx" | kind=code-symbol | source=src/routes/seo.tsx:L1 | neighbors=[36d8ccb new pages, 59bb970 eyoo, 6e488ba fixes, aabf034 SEO, Breadcrumbs.tsx, Breadcrumbs()]
- "routes_webshop_laten_maken": "webshop-laten-maken.tsx" | kind=code-symbol | source=src/routes/webshop-laten-maken.tsx:L1 | neighbors=[04c01f8 SEO, 2d81f50 feat(seo): vervang /cases door …, 5d3df91 new, 6e488ba fixes, 8fdd571 SEO, aabf034 SEO]
- "routes_website_laten_vernieuwen": "website-laten-vernieuwen.tsx" | kind=code-symbol | source=src/routes/website-laten-vernieuwen.tsx:L1 | neighbors=[36d8ccb new pages, 59bb970 eyoo, 6e488ba fixes, aabf034 SEO, Breadcrumbs.tsx, Breadcrumbs()]
...
- "routes_website_laten_maken": "website-laten-maken.tsx" | kind=code-symbol | source=src/routes/website-laten-maken.tsx:L1 | neighbors=[04c01f8 SEO, 5d3df91 new, 6e488ba fixes, 8fdd571 SEO, aabf034 SEO, bc99d99 achtegrond]
- "routes_werkwijze": "werkwijze.tsx" | kind=code-symbol | source=src/routes/werkwijze.tsx:L1 | neighbors=[04c01f8 SEO, 2d81f50 feat(seo): vervang /cases door …, 36d8ccb new pages, 5d3df91 new, 6262799 fixes, 6e488ba fixes]
...
- "components_pricing": "Pricing.tsx" | kind=code-symbol | source=src/components/Pricing.tsx:L1 | neighbors=[00e2564 voorwaaren en privacy, 36d8ccb new pages, 6262799 fixes, 6bf533b pushes, 6e488ba fixes, 735e902 Verwijder alle section-label ey…]
- "routes_contact": "contact.tsx" | kind=code-symbol | source=src/routes/contact.tsx:L1 | neighbors=[04c01f8 SEO, 36d8ccb new pages, 59bb970 eyoo, 5d3df91 new, 6e488ba fixes, 8fdd571 SEO]
