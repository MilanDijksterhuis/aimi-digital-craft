# Node Description Batch 2 of 50
...
- "routes_tarieven": "tarieven.tsx" | kind=code-symbol | source=src/routes/tarieven.tsx:L1 | neighbors=[36d8ccb new pages, 59bb970 eyoo, aabf034 SEO, cc405f4 pagina updates, dca01f9 pagina updates, CookieBanner.tsx]
...
- "components_faq": "FAQ.tsx" | kind=code-symbol | source=src/components/FAQ.tsx:L1 | neighbors=[04564c5 fixes, 1a55bd1 Fix formatting in FAQ answers, 5d3df91 new, 6262799 fixes, 735e902 Verwijder alle section-label ey…, 85ad012 Cinematisch redesign: forest he…]
...
- "routes_faq": "faq.tsx" | kind=code-symbol | source=src/routes/faq.tsx:L1 | neighbors=[36d8ccb new pages, 5d3df91 new, 8fdd571 SEO, dca01f9 pagina updates, fc7da2d animaties en paginas, CookieBanner.tsx]
...
- "routes_over_ons": "over-ons.tsx" | kind=code-symbol | source=src/routes/over-ons.tsx:L1 | neighbors=[04c01f8 SEO, 2d81f50 feat(seo): vervang /cases door …, 36d8ccb new pages, 5d3df91 new, 6262799 fixes, 8af95bc backlink]
- "routes_seo": "seo.tsx" | kind=code-symbol | source=src/routes/seo.tsx:L1 | neighbors=[36d8ccb new pages, 59bb970 eyoo, aabf034 SEO, Breadcrumbs.tsx, Breadcrumbs(), CookieBanner.tsx]
...
- "routes_website_laten_vernieuwen": "website-laten-vernieuwen.tsx" | kind=code-symbol | source=src/routes/website-laten-vernieuwen.tsx:L1 | neighbors=[36d8ccb new pages, 59bb970 eyoo, aabf034 SEO, Breadcrumbs.tsx, Breadcrumbs(), CookieBanner.tsx]
- "routes_website_laten_maken": "website-laten-maken.tsx" | kind=code-symbol | source=src/routes/website-laten-maken.tsx:L1 | neighbors=[04c01f8 SEO, 5d3df91 new, 8fdd571 SEO, aabf034 SEO, bc99d99 achtegrond, dca01f9 pagina updates]
...
- "routes_wordpress_of_maatwerk": "wordpress-of-maatwerk.tsx" | kind=code-symbol | source=src/routes/wordpress-of-maatwerk.tsx:L1 | neighbors=[36d8ccb new pages, 59bb970 eyoo, cc405f4 pagina updates, Breadcrumbs.tsx, Breadcrumbs(), CookieBanner.tsx]
...
- "components_pricing": "Pricing.tsx" | kind=code-symbol | source=src/components/Pricing.tsx:L1 | neighbors=[00e2564 voorwaaren en privacy, 36d8ccb new pages, 6262799 fixes, 6bf533b pushes, 735e902 Verwijder alle section-label ey…, 7842118 Prijs wijzing 499]
...
- "routes_contact": "contact.tsx" | kind=code-symbol | source=src/routes/contact.tsx:L1 | neighbors=[04c01f8 SEO, 36d8ccb new pages, 59bb970 eyoo, 5d3df91 new, 8fdd571 SEO, 9965896 feat(seo): contact- en cases-pa…]
