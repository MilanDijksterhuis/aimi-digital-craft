# Node Description Batch 10 of 57
...
- "commit:repo:github.com/MilanDijksterhuis/aimi-digital-craft@65b58f18e32ff3974def08ab5316d86e96fe13a5": "65b58f1 Work in progress" | kind=Commit | source=git | neighbors=[main, 9ed5748 Changes, 59d8b3c Code edited in Lovable Code Edi…, tmp-main-merge, tmp-revert-main, worktree-curious-wibbling-narwhal] | lang=en
...
- "commit:repo:github.com/MilanDijksterhuis/aimi-digital-craft@9ed5748c4b6028bc51d46bcf1cd2aa997119824c": "9ed5748 Changes" | kind=Commit | source=git | neighbors=[main, 7732f7b Changes, 65b58f1 Work in progress, tmp-main-merge, tmp-revert-main, worktree-curious-wibbling-narwhal] | lang=en
...
- "lib_markdown": "markdown.tsx" | kind=code-symbol | source=src/lib/markdown.tsx:L1 | neighbors=[1727351 blog, 4a960c6 SEO, 6ccd4dc CMS, b5c2a22 blog, BlogPostForm.tsx, estimateReadTime()] | lang=en
- "lib_seo_ld": "ld()" | kind=code-symbol | source=src/lib/seo.ts:L259 | neighbors=[seo.ts, articleJsonLd(), breadcrumbJsonLd(), contactPageJsonLd(), faqJsonLd(), itemListJsonLd()] | lang=en
- "ui_dialog": "dialog.tsx" | kind=code-symbol | source=src/components/ui/dialog.tsx:L1 | neighbors=[BulkScheduleDialog.tsx, command.tsx, utils.ts, cn(), DialogContent, DialogDescription] | lang=en
