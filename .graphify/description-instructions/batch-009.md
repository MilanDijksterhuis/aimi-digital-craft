...
- "lib_seo_ld": "ld()" | kind=code-symbol | source=src/lib/seo.ts:L257 | neighbors=[seo.ts, articleJsonLd(), breadcrumbJsonLd(), contactPageJsonLd(), faqJsonLd(), itemListJsonLd()] | lang=en
