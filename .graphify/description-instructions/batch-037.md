...
- "routes_algemene_voorwaarden_voorwaardenpage": "VoorwaardenPage()" | kind=code-symbol | source=src/routes/algemene-voorwaarden.tsx:L25 | neighbors=[algemene-voorwaarden.tsx]
...
- "routes_index_index": "Index()" | kind=code-symbol | source=src/routes/index.tsx:L55 | neighbors=[index.tsx]
