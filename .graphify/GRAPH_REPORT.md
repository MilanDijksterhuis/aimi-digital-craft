...
## Corpus Check
- Large corpus: 1028 files · ~276.445 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1371 nodes · 3648 edges · 67 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: ON_BRANCH: 1422 · contains: 964 · MODIFIES: 514 · PARENT_OF: 266 · imports: 244 · imports_from: 159 · calls: 42 · references: 23 · reads_from: 9 · triggers: 5


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 1028 · Candidates: 1344
- Excluded: 1 untracked · 35600 ignored · 8 sensitive · 18 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `9c1fa06`
...
Cohesion: 0.14
Nodes (15): c480d2e leads, TeamTab(), ensurePermission(), getEffectivePermissions(), ADMIN_LIKE_ROLES, ALL_PERMISSION_ACTIONS, AppRole, can() (+7 more)
...
## Knowledge Gaps
- **534 isolated node(s):** `Message`, `ChatRow`, `Message`, `Mode`, `CookiePrefs` (+529 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 55`** (1 nodes): `public.audit_log`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (2 nodes): `CookieBanner()`, `CookiePrefs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 61`** (2 nodes): `public.extra_change_requests`, `public.password_reset_requests`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 62`** (2 nodes): `Route`, `SitemapEntry`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 63`** (2 nodes): `cors`, `Route`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 65`** (2 nodes): `generateDueRecurringTaskInstances()`, `nextRecurrenceDueDate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 66`** (1 nodes): `public.appointments`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (1 nodes): `public.contact_submissions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `cn()` connect `Community 8` to `Community 5`, `Community 60`, `Community 44`, `Community 28`, `Community 48`, `Community 31`, `Community 37`, `Community 24`, `Community 38`, `Community 45`, `Community 39`, `Community 30`, `Community 4`, `Community 58`, `Community 25`, `Community 46`, `Community 47`, `Community 34`, `Community 42`, `Community 49`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `Skeleton()` connect `Community 34` to `Community 16`, `Community 33`, `Community 5`, `Community 11`, `Community 9`, `Community 15`, `Community 7`, `Community 4`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `requireSupabaseAuth` connect `Community 27` to `Community 14`, `Community 1`, `Community 43`, `Community 18`, `Community 6`?**
