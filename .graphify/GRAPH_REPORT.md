...
## Corpus Check
- Large corpus: 1029 files · ~278.617 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1365 nodes · 3637 edges · 73 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: ON_BRANCH: 1420 · contains: 960 · MODIFIES: 513 · PARENT_OF: 264 · imports: 243 · imports_from: 158 · calls: 42 · references: 23 · reads_from: 9 · triggers: 5


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 1029 · Candidates: 1336
- Excluded: 0 untracked · 35598 ignored · 8 sensitive · 14 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `4510b3f`
...
- `02d6137 fixes` --ON_BRANCH--> `main`  [EXTRACTED]
  git → git  _Bridges community 17 → community 0_
...
Cohesion: 0.08
Nodes (18): ALLOWED_ATTACHMENT_MIME, ChangeCard(), FILTER_LABEL, FilterKey, mapStatus(), matchesFilter(), Route, STATUS_STYLE (+10 more)
...
Cohesion: 0.23
Nodes (13): consumeLastCapturedError(), applyRateLimit(), applySecurityHeaders(), brandedErrorResponse(), fetch(), getServerEntry(), isCatastrophicSsrErrorBody(), isHttps() (+5 more)
...
Cohesion: 0.27
Nodes (6): Route, 37c0d11 Dock tokens toegevoegd & emojis weg, 97e70ec Changes, ChatWidget(), Message, DeletedChangesTab()
...
- **Thin community `Community 61`** (1 nodes): `public.audit_log`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 62`** (2 nodes): `CookieBanner()`, `CookiePrefs`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 67`** (2 nodes): `public.extra_change_requests`, `public.password_reset_requests`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (2 nodes): `Route`, `SitemapEntry`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 69`** (2 nodes): `cors`, `Route`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 71`** (2 nodes): `generateDueRecurringTaskInstances()`, `nextRecurrenceDueDate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (1 nodes): `public.appointments`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 78`** (1 nodes): `public.contact_submissions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `cn()` connect `Community 5` to `Community 4`, `Community 66`, `Community 49`, `Community 28`, `Community 54`, `Community 33`, `Community 38`, `Community 23`, `Community 42`, `Community 50`, `Community 43`, `Community 30`, `Community 3`, `Community 64`, `Community 24`, `Community 51`, `Community 52`, `Community 36`, `Community 46`, `Community 55`?**
...
- **Why does `requireSupabaseAuth` connect `Community 27` to `Community 13`, `Community 1`, `Community 47`, `Community 16`, `Community 12`?**
