...
## Corpus Check
- Large corpus: 1067 files · ~320.994 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 1652 nodes · 4459 edges · 80 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: ON_BRANCH: 1638 · contains: 1199 · MODIFIES: 617 · imports: 336 · PARENT_OF: 282 · imports_from: 220 · calls: 125 · references: 28 · reads_from: 9 · triggers: 5


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 1067 · Candidates: 1479
- Excluded: 1 untracked · 35665 ignored · 8 sensitive · 15 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `032ba88`
...
3. `supabase` - 10 edges
4. `Footer()` - 9 edges
5. `useConfirm()` - 8 edges
6. `CookieBanner()` - 8 edges
7. `Nav()` - 8 edges
...
- `1713634 fixes` --PARENT_OF--> `cf5e121 Catch getSession() network errors in the auth route guard`  [EXTRACTED]
  git → git  _Bridges community 47 → community 68_
...
Cohesion: 0.08
Nodes (198): main, seo-verbetering, tmp-main-merge, tmp-revert-main, worktree-curious-wibbling-narwhal, worktree-fix-admin-projects-hooks, worktree-floofy-conjuring-petal, worktree-replicated-fluttering-whisper (+190 more)
...
Cohesion: 0.03
Nodes (65): isAuthorized(), Route, timingSafeStringEqual(), getRouter(), AlgemeneVoorwaardenRoute, ApiPublicHooksExpireAccountsRoute, ApiPublicSiteErrorRoute, ApiPublicSitePingRoute (+57 more)
...
Cohesion: 0.13
Nodes (24): 735e902 Verwijder alle section-label eyebrows, 85ad012 Cinematisch redesign: forest hero, donkere panels, Cormorant Garamond, 98edc37 Changes, 9a2689c code fixes, ab14295 Design overhauled, A11y-bar weg, b6f9658 Redesign: donker editorial thema, Syne font, goud accent, ecdbe8e fixes, fc7da2d animaties en paginas (+16 more)
...
Cohesion: 0.09
Nodes (11): Route, Route, 37c0d11 Dock tokens toegevoegd & emojis weg, 97e70ec Changes, a903820 Fix Rules of Hooks violation crashing admin Projecten tab, BerichtenTab(), ChatWidget(), Message (+3 more)
...
Cohesion: 0.11
Nodes (20): 032ba88 SEO, 7a63e47 chore: graphify graph bijgewerkt, 9965896 feat(seo): contact- en cases-pagina met LocalBusiness/Breadcrumb schema, b48bbc0 chore: snapshot lokale SEO-pagina's (Veendam/Hoogeveen) + sitemap, e0f6b72 feat(seo): interne links op lokale landingspagina's, ef44acd feat(seo): sitemap + llms.txt aangevuld met alle nieuwe pagina's, fa2ea52 feat(seo): nav + uitgebreide footer met interne links (geen orphan pages), columns (+12 more)
...
Cohesion: 0.10
Nodes (17): 2d50590 wip: lokale wijzigingen voor pull, a3773ee sec fixes, BAN_DURATIONS_MS, BanEntry, bans, checkRateLimit(), Entry, getClientIp() (+9 more)
...
Cohesion: 0.15
Nodes (8): CookieBanner(), CookiePrefs, Nav(), Route, Route, Route, stats, values
...
Cohesion: 0.13
Nodes (9): 171eb96 leads functions, 85a6666 SEO en robot, bc842b8 leads functions, Route, LASTMOD, Route, SitemapEntry, Toaster() (+1 more)
...
## Knowledge Gaps
- **612 isolated node(s):** `Message`, `ChatRow`, `ViewMode`, `CallbackScheduleValue`, `Message` (+607 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 67`** (1 nodes): `public.audit_log`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (2 nodes): `public.extra_change_requests`, `public.password_reset_requests`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (2 nodes): `cors`, `Route`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 76`** (2 nodes): `lead_callbacks`, `leads`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 77`** (2 nodes): `generateDueRecurringTaskInstances()`, `nextRecurrenceDueDate()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 78`** (1 nodes): `public.appointments`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 84`** (1 nodes): `public.contact_submissions`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `cn()` connect `Community 7` to `Community 4`, `Community 73`, `Community 56`, `Community 34`, `Community 61`, `Community 38`, `Community 48`, `Community 28`, `Community 49`, `Community 57`, `Community 50`, `Community 37`, `Community 5`, `Community 70`, `Community 29`, `Community 58`, `Community 59`, `Community 44`, `Community 53`, `Community 62`?**
  _High betweenness centrality (0.112) - this node is a cross-community bridge._
- **Why does `Skeleton()` connect `Community 44` to `Community 11`, `Community 43`, `Community 4`, `Community 12`, `Community 8`, `Community 23`, `Community 10`, `Community 5`?**
...
- **Should `Community 0` be split into smaller, more focused modules?**
  _Cohesion score 0.08101253475101204 - nodes in this community are weakly interconnected._
