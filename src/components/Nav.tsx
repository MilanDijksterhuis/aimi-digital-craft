...
const serviceCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Gratis website check!", href: "/website-checker", desc: "Direct zien hoe jouw site scoort" },
    ],
  },
];
        ...
        >
          {serviceCategories.map((cat) => (
            <div key={cat.label} className="px-1">
              <div
                className="text-[11px] uppercase tracking-widest px-3 mb-1"
                style={{ color: "#868b94" }}
              >
                {cat.label}
              </div>
