...
/** GEO-audit 2026-09-06 (punt 10): de FAQ's zijn gegroepeerd onder thematische
 * categorieën. Op /faq worden ze per thema onder een H2 gerenderd (elke vraag als
 * H3), wat de pagina scanbaar maakt voor mens én AI-antwoordmachine. `FAQ_CATEGORIES`
 * legt de volgorde van de thema's vast; elke vraag verwijst met `category` daarnaar. */
