...
const data: LocationPageData = {
  ...
  workflowSteps: [
    {
      title: "Intake",
      desc: "We brengen in kaart wat je bedrijf doet, wie je klanten zijn en wat de website concreet moet opleveren.",
    },
    {
      title: "Structuur en ontwerp",
      desc: "We werken een heldere paginastructuur en ontwerp uit die past bij een technisch of zakelijk publiek.",
    },
    {
      title: "Ontwikkeling",
      desc: "De website wordt gebouwd met moderne, snelle technologie, met aandacht voor techniek achter de schermen.",
    },
    {
      title: "Controle en livegang",
      desc: "We testen functionaliteit, snelheid en weergave op alle apparaten voordat de website live gaat.",
    },
    {
      title: "Beheer na livegang",
      desc: "We hosten en monitoren de website zelf en houden je via een klantenportaal op de hoogte van status en updates.",
    },
  ],
  faqs: [
    {
      q: "Bouwt AIMI ook websites voor technische bedrijven en maakindustrie in Drachten?",
      a: "Ja, we hebben ervaring met het presenteren van technische producten en diensten op een heldere, geloofwaardige manier voor een zakelijk publiek.",
    },
    {
      q: "Wat kost een website laten maken in Drachten?",
      a: "De kosten hangen af van de omvang en functionaliteit die je nodig hebt. Na een kennismakingsgesprek stellen we een concrete, passende offerte op.",
    },
    {
      q: "Kan de website gekoppeld worden aan bestaande systemen?",
      a: "Afhankelijk van je situatie bespreken we de mogelijkheden voor koppelingen, zodat de website aansluit op de manier waarop je nu al werkt.",
    },
    {
      q: "Hoe zorgt AIMI voor een snelle website?",
      a: "We bouwen met moderne technologie en hosten op eigen, gemonitorde infrastructuur, met laadsnelheid als vast uitgangspunt.",
    },
    {
      q: "Onderhouden jullie de website ook na livegang?",
      a: "Ja, hosting, onderhoud en servermonitoring zijn standaard bij ons inbegrepen, zodat je er na livegang niet alleen voor staat.",
    },
    {
      q: "Werken jullie alleen voor technische bedrijven in Drachten?",
      a: "Nee, we bouwen voor uiteenlopende ondernemers in Drachten en omgeving, van technische bedrijven tot horeca en lokale dienstverleners.",
    },
  ],
  related: [
...
const DESCRIPTION =
  "Website nodig voor je technische bedrijf in Drachten? AIMI bouwt snelle, heldere websites met eigen hosting en servermonitoring. Vraag een offerte aan.";
