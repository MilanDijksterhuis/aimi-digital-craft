...
const data: LocationPageData = {
  ...
  workflowSteps: [
    {
      title: "Kennismaking",
      desc: "We inventariseren je onderneming, seizoenspatroon en doelgroep, zodat de website daarop is afgestemd.",
    },
    {
      title: "Ontwerp",
      desc: "We stellen een ontwerp op dat past bij je branche, met aandacht voor content die je zelf eenvoudig kunt bijwerken per seizoen.",
    },
    {
      title: "Bouw",
      desc: "De website wordt technisch gebouwd met snelheid en stabiliteit als uitgangspunt, ook onder verhoogde bezoekersdrukte.",
    },
    {
      title: "Testen",
      desc: "We testen de website grondig, inclusief belasting en weergave op mobiele apparaten, voor livegang.",
    },
    {
      title: "Livegang en beheer",
      desc: "Na livegang hosten en monitoren we de website zelf, met een klantenportaal voor overzicht en snelle aanpassingen.",
    },
  ],
  faqs: [
    {
      q: "Kan mijn website tegen de drukte van de Sneekweek?",
      a: "We bouwen en hosten websites met performance en stabiliteit als uitgangspunt, zodat ook piekperiodes zoals de Sneekweek geen probleem vormen.",
    },
    {
      q: "Wat kost een website laten maken in Sneek?",
      a: "De kosten zijn afhankelijk van de omvang van je project. Na een kennismakingsgesprek stellen we een passende offerte op.",
    },
    {
      q: "Kan ik zelf openingstijden en aanbod per seizoen aanpassen?",
      a: "Ja, je krijgt een beheeromgeving waarmee je zelf eenvoudig content kunt bijwerken wanneer het seizoen verandert.",
    },
    {
      q: "Bouwt AIMI ook websites voor watersport- en verhuurbedrijven?",
      a: "Ja, we hebben ervaring met het overzichtelijk presenteren van aanbod, arrangementen en beschikbaarheid voor de watersport- en toeristensector.",
    },
    {
      q: "Werken jullie ook voor lokale bedrijven buiten het toeristische seizoen?",
      a: "Zeker, we bouwen ook websites voor dienstverleners en zakelijke ondernemingen in Sneek die het hele jaar door actief zijn.",
    },
    {
      q: "Hoe snel is een website van AIMI?",
      a: "We bouwen met moderne technologie en hosten op eigen, gemonitorde infrastructuur, met laadsnelheid als vast aandachtspunt.",
    },
    {
      q: "Zorgen jullie ook voor onderhoud na livegang?",
      a: "Ja, hosting, servermonitoring en onderhoud zijn standaard bij ons inbegrepen.",
    },
  ],
  related: [
...
const DESCRIPTION =
  "Ondernemer in Sneek? AIMI bouwt snelle websites die ook tijdens de Sneekweek en drukke seizoenen stabiel en vindbaar blijven. Vraag een offerte aan.";
