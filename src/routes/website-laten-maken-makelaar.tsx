...
const data: BranchPageData = {
  ...
  needsBody: [
    ...
    "Verkochte woningen zijn daarom je sterkste bewijsmateriaal. Niet als eindeloze lijst, maar als selectie die laat zien dat je in dit type woning en deze prijsklasse thuis bent. Iemand met een jaren-dertig woning wil zien dat je jaren-dertig woningen verkoopt. We bouwen dat overzicht zo dat je zelf een woning kunt toevoegen zodra hij is overgedragen, of koppelen 'm aan je bestaande CRM- of makelaarssysteem zodat nieuw aanbod automatisch doorstroomt.",
  ...
  approachSteps: [
    {
      title: "Kennismaking",
      desc: "We bespreken je werkgebied, het type woningen waar je sterk in bent en of je vooral op verkoop, aankoop of taxatie zit.",
    },
    {
      title: "Positionering",
      desc: "We bepalen waarmee je je onderscheidt van de andere kantoren in je plaats, en bouwen de site rond dat verhaal in plaats van rond het aanbod.",
    },
    {
      title: "Bewijs verzamelen",
      desc: "We richten een overzicht van verkochte woningen in, plus ruimte voor ervaringen van verkopers die je zelf kunt aanvullen.",
    },
    {
      title: "Waardebepaling inrichten",
      desc: "We bouwen een kort aanvraagformulier met een lage drempel, zodat het daadwerkelijk wordt ingevuld.",
    },
    {
      title: "Livegang en beheer",
      desc: "Na livegang voeg je zelf woningen en ervaringen toe; wij verzorgen hosting, back-ups en monitoring.",
    },
  ],
  ...
  faqs: [
    {
      q: "Heeft een eigen website nog zin als iedereen op de grote platforms kijkt?",
      a: "Ja, maar met een ander doel. Kopers vind je via de platforms; verkopers kiezen jou. Je website is het middel waarmee iemand die zijn huis wil verkopen besluit om jou te bellen in plaats van het kantoor verderop.",
    },
    {
      q: "Kan mijn woningaanbod automatisch op de site komen?",
      a: "Vaak wel. Werk je met een vastgoedsysteem dat een koppeling of export aanbiedt, dan kunnen we het aanbod automatisch laten doorstromen. We kijken bij de kennismaking wat jouw systeem ondersteunt.",
    },
    {
      q: "Moet ik mijn courtage op de site zetten?",
      a: "Dat hoeft niet, maar volledige stilte werkt tegen je. Uitleggen hoe je tarief is opgebouwd en waar het ongeveer ligt, wekt vertrouwen en scheelt je gesprekken met mensen die iets anders zoeken.",
    },
    {
    ...
    },
    {
      ...
      a: "Zeker. Dat zijn andere diensten met een andere bezoeker, dus die krijgen een eigen pagina met eigen tekst en een eigen aanvraagpad, in plaats van een voetnoot op de verkooppagina.",
    },
    {
      q: "Kunnen jullie garanderen dat ik bovenaan kom op 'makelaar' plus mijn plaats?",
      a: "Nee, en dat belooft niemand die eerlijk is. We leggen een technisch gezonde basis en zorgen dat je pagina's inhoudelijk kloppen. Posities zijn daarna een kwestie van content, tijd en concurrentie.",
    },
    {
      q: "Hoe lang duurt het bouwen van een website voor mijn makelaarskantoor?",
      a: "Een standaard website met woningaanbod en waardebepalingsformulier staat gemiddeld binnen 2 tot 4 weken live, afhankelijk van hoe snel we woningaanbod en teksten ontvangen.",
    },
  ],
  related: [
  ...
  head: () => ({
    meta: [
      { title: "Website laten maken voor je makelaarskantoor | AIMI" },
      {
        name: "description",
        content:
          "Website voor je makelaarskantoor die verkopers overtuigt: verkochte woningen als bewijs, heldere tarieven en een waardebepaling met lage drempel.",
      },
      { property: "og:title", content: "Website laten maken voor je makelaarskantoor | AIMI" },
      {
        property: "og:description",
        content:
          "Webdesign voor makelaars: acquisitie van verkoopopdrachten in plaats van concurreren met de grote huizenplatforms.",
      },
