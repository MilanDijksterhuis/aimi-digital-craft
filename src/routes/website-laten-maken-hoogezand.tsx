...
const data: LocationPageData = {
  ...
  workflowSteps: [
    {
      title: "Kennismaking dichtbij huis",
      desc: "Omdat we vanuit Veendam werken, is de lijn met ondernemers in Hoogezand kort. We bespreken telefonisch of op locatie wat je nodig hebt.",
    },
    {
      title: "Ontwerp gericht op je bedrijf",
      desc: "We ontwerpen een website die past bij het karakter van je onderneming, of dat nu een productiebedrijf, installateur of zzp'er is.",
    },
    {
      title: "Techniek zonder omwegen",
      desc: "We bouwen zelf, zonder trage bouwpakketten, zodat de website snel laadt op zowel desktop als mobiel.",
    },
    {
      title: "Testen en livegang",
      desc: "Voor livegang controleren we de website op verschillende apparaten, zodat klanten in Hoogezand meteen een goede eerste indruk krijgen.",
    },
    {
      title: "Onderhoud en klantenportaal",
      desc: "Na oplevering hosten we de site op eigen servers met monitoring en beheer je aanvragen via het klantenportaal.",
    },
  ],
  ...
  faqs: [
    {
      q: "Werkt AIMI ook echt dichtbij als je in Hoogezand zit?",
      a: "Ja, we zijn gevestigd in de buurgemeente Veendam, wat betekent dat persoonlijk contact en eventueel een afspraak op locatie eenvoudig te regelen zijn.",
    },
    {
      q: "Is AIMI geschikt voor bedrijven uit de maakindustrie in Hoogezand?",
      a: "We bouwen regelmatig websites voor technische bedrijven en installateurs die vooral behoefte hebben aan duidelijkheid over hun diensten en een goed werkend contactformulier.",
    },
    {
      q: "Wat kost een website laten maken in Hoogezand?",
      a: "De prijs hangt af van de omvang van het project. Bekijk de tarieven op onze website of vraag een vrijblijvende offerte aan.",
    },
    {
      q: "Kan ik mijn verouderde website laten vernieuwen?",
      a: "Zeker, we vervangen regelmatig bestaande websites die technisch verouderd zijn of niet meer goed werken op mobiel, met behoud van wat al goed werkte.",
    },
    {
      q: "Hoe snel is mijn nieuwe website klaar?",
      a: "Na de kennismaking en het aanleveren van content stemmen we een realistische planning met je af, afgestemd op de omvang van het project.",
    },
    {
      q: "Bieden jullie ook hosting aan voor bedrijven in Hoogezand?",
      a: "Ja, we hosten websites op eigen servers met monitoring, zodat storingen snel worden opgemerkt en de website betrouwbaar online blijft.",
    },
    {
      q: "Kan ik zelf aanpassingen laten doorvoeren na livegang?",
      a: "Via het klantenportaal kun je eenvoudig aanpassingen aanvragen, zonder dat je zelf hoeft te programmeren.",
    },
  ],
  related: [
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Website laten maken in Hoogezand | AIMI" },
      {
        ...
        content:
          "Snelle, professionele websites voor ondernemers in Hoogezand en Midden-Groningen.",
      },
    ...
    scripts: [
      serviceJsonLd({
        ...
        description:
          "Webdesign en websites op maat voor ondernemers in Hoogezand en Midden-Groningen.",
        url: URL,
