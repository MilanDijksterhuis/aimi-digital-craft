  ...
  workflowSteps: [
    {
      ...
      desc: "We bespreken je doelen, doelgroep en concurrenten in Leeuwarden en de regio, en brengen in kaart wat je website moet kunnen presteren.",
    },
    {
      title: "Ontwerp op maat",
      desc: "Op basis van jouw huisstijl en branche stellen we een ontwerp op dat past bij hoe je bedrijf zich wil presenteren, geen kant-en-klaar sjabloon.",
    },
    {
      title: "Bouw en techniek",
      desc: "We bouwen de website met moderne, snelle technologie en zetten de basis voor zoekmachinevindbaarheid direct goed neer.",
    },
    {
      title: "Testen en livegang",
      desc: "Voor livegang testen we snelheid, weergave op verschillende apparaten en formulieren, zodat alles bij lancering foutloos werkt.",
    },
    {
      title: "Hosting en onderhoud",
      desc: "Na livegang hosten en monitoren we je website zelf, met een klantenportaal waarin je inzicht hebt in status en aanpassingen.",
    },
  ],
  faqs: [
    {
      q: "Wat kost een website laten maken in Leeuwarden?",
      a: "De prijs hangt af van de omvang en functionaliteit van je website. In een vrijblijvend gesprek bekijken we samen wat je nodig hebt en stellen we een passende offerte op, zonder verrassingen achteraf.",
    },
    {
      q: "Werkt AIMI ook voor culturele en creatieve organisaties in Leeuwarden?",
      a: "Ja. We hebben ervaring met het bouwen van websites die beeld en verhaal centraal stellen, wat goed aansluit bij de culturele sector die in Leeuwarden sterk vertegenwoordigd is.",
    },
    {
      q: "Kan ik zelf tekst en beeld aanpassen na livegang?",
      a: "Ja, je krijgt toegang tot een beheeromgeving waarmee je zelf content kunt bijwerken. Voor grotere aanpassingen staan we via het klantenportaal en persoonlijk contact voor je klaar.",
    },
    {
      q: "Hoe snel is een website van AIMI?",
      a: "We bouwen met moderne technologie en hosten op eigen, gemonitorde infrastructuur, met laadsnelheid als vast aandachtspunt bij elk project.",
    },
    {
      q: "Bouwen jullie ook webshops voor ondernemers in Leeuwarden?",
      a: "Ja, naast informatieve websites bouwen we ook webshops, afgestemd op het aanbod en de schaal van je onderneming.",
    },
    {
      q: "Wanneer kan mijn website live staan?",
      a: "Dat verschilt per project, maar na de kennismaking geven we een realistische planning zodat je weet wanneer je website live gaat.",
    },
    {
      q: "Bieden jullie ook onderhoud en hosting aan na livegang?",
      a: "Ja, hosting, servermonitoring en onderhoud zijn standaard onderdeel van onze dienstverlening, zodat je na livegang niet alleen komt te staan.",
    },
  ],
  related: [
...
const DESCRIPTION =
  "Professioneel webdesign voor Leeuwarden: snelle websites op maat voor culturele organisaties, horeca en het brede Friese MKB, gebouwd door AIMI.";
