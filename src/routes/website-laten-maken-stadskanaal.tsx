  ...
  workflowSteps: [
    {
      ...
      desc: "We bespreken je bedrijf, doelgroep en doelen, zodat de website aansluit op hoe je werkt en wat klanten in Stadskanaal van je verwachten.",
    },
    {
      title: "Ontwerp op maat",
      desc: "Geen kant-en-klaar sjabloon, maar een ontwerp dat past bij jouw bedrijf, met een heldere structuur en aandacht voor snelheid vanaf de eerste schets.",
    },
    {
      title: "Bouw en techniek",
      desc: "We bouwen de site met eigen, moderne techniek gericht op korte laadtijden, zodat bezoekers en Google de site waarderen.",
    },
    {
      title: "Livegang en controle",
      desc: "Voor livegang testen we alles grondig: van formulieren tot weergave op telefoon, tablet en desktop.",
    },
    {
      title: "Hosting en servermonitoring",
      desc: "Na oplevering draait je website op onze eigen hosting met actieve servermonitoring, zodat problemen vroeg worden gesignaleerd.",
    },
    {
      title: "Beheer via klantenportaal",
      desc: "Via een persoonlijk klantenportaal houd je overzicht op je website en kun je eenvoudig contact opnemen voor aanpassingen.",
    },
  ],
  faqs: [
    {
      q: "Wat kost een website laten maken in Stadskanaal?",
      a: "De prijs hangt af van de omvang en functionaliteit van de website. We bespreken dit altijd vooraf, zodat je precies weet waar je aan toe bent, zonder verrassingen achteraf.",
    },
    {
      q: "Werkt AIMI ook voor bedrijven buiten Stadskanaal zelf?",
      a: "Ja, veel klanten komen uit de dorpen rond Stadskanaal. Omdat de plaats een regionale centrumfunctie heeft, richten we websites vaak in op zichtbaarheid in zowel Stadskanaal als het omliggende verzorgingsgebied.",
    },
    {
      q: "Hoe snel is mijn website klaar?",
      a: "Dat verschilt per project. Na de kennismaking geven we een realistische inschatting op basis van de gewenste functionaliteit en het beschikbare materiaal.",
    },
    {
      q: "Kan ik zelf teksten en foto's aanpassen na livegang?",
      a: "Ja, via het klantenportaal kun je eenvoudig in contact blijven over aanpassingen, en waar gewenst richten we de site zo in dat je zelf kleine wijzigingen kunt doen.",
    },
    {
      q: "Bouwt AIMI ook webshops voor winkels in Stadskanaal?",
      a: "Zeker. Voor winkeliers die naast hun fysieke zaak online willen verkopen, bouwen we webshops die aansluiten op het assortiment en de uitstraling van de winkel.",
    },
    {
      q: "Waarom is laadsnelheid zo belangrijk voor mijn website?",
      a: "Een trage website verliest bezoekers en scoort slechter in Google. Onze eigen techniek en hosting zijn gericht op korte laadtijden, wat direct bijdraagt aan meer klanten.",
    },
    {
      q: "Blijft AIMI betrokken na oplevering?",
      a: "Ja. Dankzij servermonitoring en het klantenportaal houden we vinger aan de pols en zijn we bereikbaar voor vragen of aanpassingen, ook na livegang.",
    },
  ],
  related: [
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Website laten maken in Stadskanaal | AIMI" },
      {
        ...
        content:
          "Snelle, professionele websites en webshops voor ondernemers in Stadskanaal en omgeving.",
      },
    ...
    scripts: [
      serviceJsonLd({
        ...
        description:
          "Webdesign en websiteontwikkeling voor ondernemers in Stadskanaal en omgeving.",
        url: URL,
