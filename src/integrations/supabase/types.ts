...
export type Database = {
  ...
  public: {
    ...
    Enums: {
      app_role:
        "admin" | "customer" | "super_admin" | "co_admin" | "support_agent" | "viewer" | "sales";
      ...
      request_status:
        ...
        | "cancelled";
      project_status:
        "concept" | "in_uitvoering" | "review" | "afgerond" | "on_hold" | "geannuleerd";
...
export const Constants = {
  public: {
    Enums: {
      ...
      project_status: ["concept", "in_uitvoering", "review", "afgerond", "on_hold", "geannuleerd"],
      project_priority: ["laag", "normaal", "hoog", "urgent"],
    },
  },
} as const;
